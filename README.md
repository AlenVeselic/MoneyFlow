...
# Building a debug bundle that doesn't require a running Metro server
...
The following steps can be repeated as many times as you want a new apk.

3. Run this command from the project's root directory
